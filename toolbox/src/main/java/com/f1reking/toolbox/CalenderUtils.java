...
public class CalenderUtils {
    ...
    public void setGregorianYear(int gregorianYear) {
        CalenderUtils.gregorianYear = gregorianYear;
    }
    ...
    public void setGregorianMonth(int gregorianMonth) {
        CalenderUtils.gregorianMonth = gregorianMonth;
    }
    ...
    public void setGregorianDate(int gregorianDate) {
        CalenderUtils.gregorianDate = gregorianDate;
    }
    ...
    public void setGregorianLeap(boolean isGregorianLeap) {
        CalenderUtils.isGregorianLeap = isGregorianLeap;
    }
    ...
    public void setDayOfYear(int dayOfYear) {
        CalenderUtils.dayOfYear = dayOfYear;
    }
    ...
    public void setDayOfWeek(int dayOfWeek) {
        CalenderUtils.dayOfWeek = dayOfWeek;
    }
    ...
    public void setChineseYear(int chineseYear) {
        CalenderUtils.chineseYear = chineseYear;
    }
    ...
    public void setChineseMonth(int chineseMonth) {
        CalenderUtils.chineseMonth = chineseMonth;
    }
    ...
    public void setChineseDate(int chineseDate) {
        CalenderUtils.chineseDate = chineseDate;
    }
    ...
    public void setSectionalTerm(int sectionalTerm) {
        CalenderUtils.sectionalTerm = sectionalTerm;
    }
    ...
    public void setPrincipleTerm(int principleTerm) {
        CalenderUtils.principleTerm = principleTerm;
    }
